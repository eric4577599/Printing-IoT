...
> 零件管理與保養維修功能已於 2026-07 隨 C′ 遷移移入獨立外掛 MM（`/Volumes/G70Pro/cusor pool/MM/`）。MM 對外入口 `mms.ericchh.work` 已於 2026-07-07 完成 Cloudflare 設定並生效上線，目前正常上線中（2026-07-08 對抗性稽核發現的三項安全問題，已於 2026-07-09 修復完成並恢復對外）。本機入口 `http://localhost:5301`。
