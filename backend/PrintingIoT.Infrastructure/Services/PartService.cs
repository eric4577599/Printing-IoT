...
/// <summary>
/// PartService — 零件服務實作
/// Migrated from SmartParts.API.Services.PartService (Phase 3.3)
/// Now uses unified PrintingContext instead of SmartPartsDbContext.
/// </summary>
public class PartService : IPartService
{
    private readonly PrintingContext _context;

    public PartService(PrintingContext context)
    {
        _context = context;
    }
